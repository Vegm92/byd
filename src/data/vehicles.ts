...
const formatConsumption = (
  consumption:
    | { low?: number | null; medium?: number | null; high?: number | null; combined?: number | null; weighted_combined?: number | null }
    | number
    | null
    | undefined
): string | undefined => {
...
const convertSpecToVehicle = (spec: VehicleSpec): Vehicle => {
  ...
  const images = carImage || {
    image: `${base}car-images/byd/atto2-ev.webp`,
    imageDetail: `${base}car-images/byd/atto2-ev.webp`,
  };
