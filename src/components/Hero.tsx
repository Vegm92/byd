      ...
      <div className="container relative z-10 px-4 py-20">
        <div className="max-w-4xl mx-auto text-center space-y-10">
          <div className="space-y-6">
            <span
              className="block text-sm md:text-base font-semibold tracking-[0.4em] uppercase"
              style={{ color: "var(--byd-red)" }}
            >
              New
            </span>
            ...
            <p
              className="text-sm md:text-base uppercase tracking-[0.6em]"
              style={{ color: "var(--byd-gray)" }}
            >
              Barcelona 2025
            </p>
          </div>
